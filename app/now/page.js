...
export default function Now() {
    return (
        ...
        <section className="flex h-fit md:h-[calc(100vh-68px)] lg:h-[calc(100vh-68px)] flex-col lg:flex-row items-start justify-center lg:justify-start bg-midnightblue p-8 lg:px-16 lg:pb-16">
