    ...
    return (
        <section className="p-6 bg-midnightblue text-white lg:px-[20%]">
            ...
            <div className="flex flex-col items-center">
                <Link href="/ResumeUmarWaseem.pdf" className="text-lg text-red-600  font-semibold mb-6 underline underline-offset-8">Download The Resume</Link>
                ...
                <motion.div
                    ...
                    animate="visible"
                >
                    <h1 className="text-4xl font-bold mb-2 text-center">Muhammad Umar Waseem</h1>
                    ...
                    <h2 className="text-3xl font-semibold my-2 underline underline-offset-8">Professional Summary</h2>
                    <p className="mb-4 text-gray-400 text-lg leading-6 lg:leading-7">
                    ...
                    <h2 className="text-3xl font-semibold my-2 underline underline-offset-8">Experience</h2>
                    <h3 className="text-xl font-semibold">Software Engineer</h3>
                    <p className="italic mb-1">Cowlar Design Studio, Islamabad, Pakistan</p>
                    <ul className="list-disc pl-5 mb-4 text-gray-400 text-lg leading-6 lg:leading-7">
                    ...
                    <h3 className="text-xl font-semibold">Head App Development</h3>
                    ...
                    <h2 className="text-3xl font-semibold my-2 underline underline-offset-8">Skills</h2>
                    <p className="mb-4 text-gray-400 text-lg leading-6 lg:leading-7">Python - TensorFlow / Keras / PyTorch - Numpy / Pandas - MLflow - Flask / Django / Model Deployments - Docker / Kubernetes / GitHub Actions / Jenkins - Jira / Airflow / C++ / Backend Development / Node.js / Golang</p>
                    <h2 className="text-3xl font-semibold mb-2 underline underline-offset-8">Projects</h2>
                    <h3 className="text-xl font-semibold">Retrieval Augmented Gemini Chatbot</h3>
                    <ul className="list-disc pl-5 mb-4 text-gray-400 text-lg leading-6 lg:leading-7">
                    ...
                    <h3 className="text-xl font-semibold">Airflow Data Extraction Pipeline</h3>
                    <ul className="list-disc pl-5 mb-4 text-gray-400 text-lg leading-6 lg:leading-7">
                    ...
                    <h3 className="text-xl font-semibold">IslamKGHub Final Year Project</h3>
                    <ul className="list-disc pl-5 mb-4 text-gray-400 text-lg leading-6 lg:leading-7">
                    ...
                    <h3 className="text-xl font-semibold">GAN Cifar-10 Generative Image Modeling</h3>
                    <ul className="list-disc pl-5 mb-4 text-gray-400 text-lg leading-6 lg:leading-7">
                    ...
                    <h3 className="text-xl font-semibold">Siamese Networks Image Similarity</h3>
                    <ul className="list-disc pl-5 mb-4 text-gray-400 text-lg leading-6 lg:leading-7">
                    ...
                    <h3 className="text-xl font-semibold">Golang Blockchain</h3>
                    <ul className="list-disc pl-5 mb-4 text-gray-400 text-lg leading-6 lg:leading-7">
                    ...
                    <h2 className="text-3xl font-semibold my-2 underline underline-offset-8">Education</h2>
                    <h3 className="text-xl font-semibold">Bachelors of Computer Science</h3>
                    <div class="flex flex-row justify-between">
                        <p className="mb-4 text-white text-md leading-6 lg:leading-7 italic">Fast National University of Computer and Emerging Sciences</p>
                    ...
                    <h2 className="text-3xl font-semibold my-2 underline underline-offset-8">Certifications</h2>
                    <ul className="list-disc pl-5 mb-4 text-gray-400 text-lg leading-6 lg:leading-7">
                        <li>Azure AZ900</li>
                        <li>Aws Certified Cloud Practitioner (in progress)</li>
                    </ul>
                    <h2 className="text-3xl font-semibold mb-2 underline underline-offset-8">Volunteer Work</h2>
                    <ul className="list-disc pl-5 mb-4 text-gray-400 text-lg leading-6 lg:leading-7">
