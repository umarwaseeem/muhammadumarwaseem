...
export default function Main() {
    const h1 = "building full-stack AI based solutions for businesses";
        ...
        <div className="flex flex-col bg-midnightblue">
            <main className="bg-midnightblue">
                <div className="flex h-[calc(100vh-68px)] flex-col lg:w-3/5 lg:items-start items-start justify-center lg:justify-end p-4 lg:p-16 lg:pb-40">
                    <SocialIcons />
                    <h1 className="px-2 font-semibold text-4xl md:text-5xl lg:text-6xl text-white lg:text-left mb-2 text-left">{h1}</h1>
