...
export default function ResumeComponent() {
    return (
        ...
        >
            ...
            <h2 className="text-xl lg:text-3xl font-medium my-2 underline underline-offset-8">Experience</h2>
            <h3 className="text-lg lg:text-xl font-normal">Software Engineer</h3>
            ...
            <h3 className="text-lg lg:text-xl font-normal">Head App Development</h3>
            ...
            <h3 className="text-lg lg:text-xl font-normal">Freelance Software Engineer</h3>
            <p className="italic mb-1">Google Student Developers Club, Islamabad, Pakistan</p>
            <ul className="list-disc pl-5 mb-4 text-gray-400 text-md lg:text-lg leading-6 lg:leading-7">
            ...
            <h2 className="text-xl lg:text-3xl font-medium my-2 underline underline-offset-8">Skills</h2>
            ...
            <h2 className="text-xl lg:text-3xl font-medium mb-2 underline underline-offset-8">Projects</h2>
            <h3 className="text-lg lg:text-xl font-normal">Retrieval Augmented Gemini Chatbot</h3>
            <ul className="list-disc pl-5 mb-4 text-gray-400 text-md lg:text-lg leading-6 lg:leading-7">
            ...
            <h3 className="text-lg lg:text-xl font-normal">Airflow Data Extraction Pipeline</h3>
            <ul className="list-disc pl-5 mb-4 text-gray-400 text-md lg:text-lg leading-6 lg:leading-7">
            ...
            <h3 className="text-lg lg:text-xl font-normal">IslamKGHub Final Year Project</h3>
            <ul className="list-disc pl-5 mb-4 text-gray-400 text-md lg:text-lg leading-6 lg:leading-7">
            ...
            <h3 className="text-lg lg:text-xl font-normal">GAN Cifar-10 Generative Image Modeling</h3>
            <ul className="list-disc pl-5 mb-4 text-gray-400 text-md lg:text-lg leading-6 lg:leading-7">
            ...
            <h3 className="text-lg lg:text-xl font-normal">Siamese Networks Image Similarity</h3>
            <ul className="list-disc pl-5 mb-4 text-gray-400 text-md lg:text-lg leading-6 lg:leading-7">
            ...
            <h3 className="text-lg lg:text-xl font-normal">Golang Blockchain</h3>
            <ul className="list-disc pl-5 mb-4 text-gray-400 text-md lg:text-lg leading-6 lg:leading-7">
            ...
            <h2 className="text-xl lg:text-3xl font-medium my-2 underline underline-offset-8">Education</h2>
